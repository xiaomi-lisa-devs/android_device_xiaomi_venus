...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/libmialgo_pureShot.so', 'vendor/lib64/libmialgo_rfs.so', 'vendor/lib64/libmiphone_preview_bokeh.so', 'vendor/lib64/libarcsoft_hdrplus_hvx_stub.so', 'vendor/lib64/libarcsoft_super_night_raw.so'): blob_fixup()
